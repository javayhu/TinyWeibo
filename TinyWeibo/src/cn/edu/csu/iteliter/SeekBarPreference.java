 ...
 * <p>
 * It is a subclass of {@link DialogPreference} and shows the {@link SeekBar} in a dialog. This {@link SeekBar} can be
 * modified either programmatically via {@link #getSeekBar()}, or through XML by setting any SeekBar attributes on the
 * SeekBarPreference.
 * <p>
...
public class SeekBarPreference extends DialogPreference {
	...
	protected void onAddSeekBarToDialogView(View dialogView, View view) {
		...
		if (container != null) {
			container.addView(view, ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
		}
	}
