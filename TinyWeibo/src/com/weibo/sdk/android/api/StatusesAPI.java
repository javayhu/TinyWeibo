...
public class StatusesAPI extends WeiboAPI {
	 ...
	 * @param listener
	 */
	public void friendsTimeline(long since_id, long max_id, int count, int page, boolean base_app, FEATURE feature,
	 ...
	 * @param listener
	 */
	public void friendsTimelineIds(long since_id, long max_id, int count, int page, boolean base_app, FEATURE feature,
	 ...
	 * @param listener
	 */
	public void homeTimeline(long since_id, long max_id, int count, int page, boolean base_app, FEATURE feature,
			boolean trim_user, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("since_id", since_id);
		params.add("max_id", max_id);
	 ...
	 * @param listener
	 */
	public void userTimeline(long since_id, long max_id, int count, int page, boolean base_app, FEATURE feature,
			boolean trim_user, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("since_id", since_id);
		params.add("max_id", max_id);
	...
	public void userTimelineIds(long uid, long since_id, long max_id, int count, int page, boolean base_app,
		...
		params.add("feature", feature.ordinal());
		request(SERVER_URL_PRIX + "/user_timeline/ids.json", params, HTTPMETHOD_GET, listener);
	}
	...
	public void repostTimelineIds(long id, long since_id, long max_id, int count, int page,
		...
		params.add("page", page);
		params.add("filter_by_author", filter_by_author.ordinal());
		request(SERVER_URL_PRIX + "/repost_timeline/ids.json", params, HTTPMETHOD_GET, listener);
	}
	 ...
	 * @param listener
	 */
	public void mentions(long since_id, long max_id, int count, int page, AUTHOR_FILTER filter_by_author,
			SRC_FILTER filter_by_source, TYPE_FILTER filter_by_type, boolean trim_user, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("since_id", since_id);
		params.add("max_id", max_id);
		params.add("count", count);
	 ...
	 * @param listener
	 */
	public void mentionsIds(long since_id, long max_id, int count, int page, AUTHOR_FILTER filter_by_author,
			SRC_FILTER filter_by_source, TYPE_FILTER filter_by_type, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("since_id", since_id);
		params.add("max_id", max_id);
		params.add("count", count);
	 ...
	 * @param listener
	 */
	public void bilateralTimeline(long since_id, long max_id, int count, int page, boolean base_app, FEATURE feature,
			boolean trim_user, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("since_id", since_id);
		params.add("max_id", max_id);
		...
		request(SERVER_URL_PRIX + "/bilateral_timeline.json", params, HTTPMETHOD_GET, listener);
	}
	...
	public void hotRepostWeekly(int count, boolean base_app, RequestListener listener) {
		...
		request(SERVER_URL_PRIX + "/hot/repost_weekly.json", params, HTTPMETHOD_GET, listener);
	}
	...
	public void hotCommentsDaily(int count, boolean base_app, RequestListener listener) {
		...
		request(SERVER_URL_PRIX + "/hot/comments_daily.json", params, HTTPMETHOD_GET, listener);
	}
	...
	public void hotCommentsWeekly(int count, boolean base_app, RequestListener listener) {
		...
		request(SERVER_URL_PRIX + "/hot/comments_weekly.json", params, HTTPMETHOD_GET, listener);
	}
