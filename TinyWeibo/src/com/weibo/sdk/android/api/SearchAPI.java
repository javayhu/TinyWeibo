...
public class SearchAPI extends WeiboAPI {
	...
	public void users(String q, int count, RequestListener listener) {
		...
		request(SERVER_URL_PRIX + "/suggestions/users.json", params, HTTPMETHOD_GET, listener);
	}
	...
	public void statuses(String q, int count, RequestListener listener) {
		...
		params.add("q", q);
		params.add("count", count);
		request(SERVER_URL_PRIX + "/suggestions/statuses.json", params, HTTPMETHOD_GET, listener);
	}
	...
	public void schools(String q, int count, SCHOOL_TYPE type, RequestListener listener) {
		...
		request(SERVER_URL_PRIX + "/suggestions/schools.json", params, HTTPMETHOD_GET, listener);
	}
	...
	public void companies(String q, int count, RequestListener listener) {
		...
		params.add("q", q);
		params.add("count", count);
		request(SERVER_URL_PRIX + "/suggestions/companies.json", params, HTTPMETHOD_GET, listener);
	}
	 ...
	 * @param listener
	 */
	public void atUsers(String q, int count, FRIEND_TYPE type, RANGE range, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("q", q);
		params.add("count", count);
		params.add("type", type.ordinal());
		params.add("range", range.ordinal());
		request(SERVER_URL_PRIX + "/suggestions/at_users.json", params, HTTPMETHOD_GET, listener);
	}
}
