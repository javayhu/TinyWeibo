...
/**
 * 此类封装了“access_token”，“expires_in”，"refresh_token"， 并提供了他们的管理功能
 * 
...
public class Oauth2AccessToken {
	...
	/**
	 * 根据服务器返回的responsetext生成Oauth2AccessToken 的构造函数， 此方法会将responsetext里的“access_token”，“expires_in”，"refresh_token"解析出来
	 * 
	 * @param responsetext
	 *            服务器返回的responsetext
	 */
	...
	public boolean isSessionValid() {
		return (!TextUtils.isEmpty(mAccessToken) && (mExpiresTime == 0 || (System.currentTimeMillis() < mExpiresTime)));
	}
