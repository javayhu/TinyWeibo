...
public class Place extends Weibo {
	...
	public StatusWapper nearbyTimeline(double lat, double lon) throws WeiboException {
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/nearby_timeline.json",
				new PostParameter[] { new PostParameter("lat", lat), new PostParameter("long", lon) }));
	}

	public UserWapper nearbyUsers(double lat, double lon) throws WeiboException {
		return User.constructWapperUsers(client.get(WeiboConfig.getValue("baseURL") + "place/nearby/users.json",
				new PostParameter[] { new PostParameter("lat", lat), new PostParameter("long", lon) }));
	}
