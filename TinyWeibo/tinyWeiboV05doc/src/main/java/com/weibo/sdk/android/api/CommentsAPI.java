...
public class CommentsAPI extends WeiboAPI {
	 ...
	 * @param listener
	 */
	public void show(long id, long since_id, long max_id, int count, int page, AUTHOR_FILTER filter_by_author,
	 ...
	 * @param listener
	 */
	public void byME(long since_id, long max_id, int count, int page, SRC_FILTER filter_by_source,
			RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("since_id", since_id);
		params.add("max_id", max_id);
	 ...
	 * @param listener
	 */
	public void toME(long since_id, long max_id, int count, int page, AUTHOR_FILTER filter_by_author,
